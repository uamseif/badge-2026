...
| Botón | Descripción |
|:-------:|-------------|
| **MENU** | Dependiente del contexto: **pulsación corta** = acción, **pulsación larga** = salir / volver |
| **A** | Arriba / anterior |
| **B** | Izquierda |
| **C** | Derecha |
| **D** | Abajo / siguiente |

> **Pulsación larga**: mantener el botón pulsado aproximadamente un segundo hasta que la acción se active.

---

## Menú de juegos

El menú desplaza el nombre del juego seleccionado en el color correspondiente a ese juego. También permite seleccionar el **editor de nombre**.
